...
////////////////////////////////////////////////////////////////////////
#if v8_p3_plugin_CONFIG_HAVE_LIBLTDL // prefer libltdl, but if it's not available...
#  include <ltdl.h>
...
#if v8_p3_plugin_CONFIG_HAVE_LIBLTDL
	    lt_dlinit();
	    lt_dlopen( 0 );
#else
...
#if v8_p3_plugin_CONFIG_HAVE_LIBLTDL // libltdl:
