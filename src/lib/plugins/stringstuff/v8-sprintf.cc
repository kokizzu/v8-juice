...
TODO: refactor the older, more generic format handler code to get a more
custom-fit/efficient solution.
************************************************************************/
...
#define NEXT_ARG (argv[argpos++])
    String::AsciiValue argCStr(Null());
#define SETUP_CSTR String::AsciiValue argCStr(NEXT_ARG)
#define CSTR (argCStr)
    String::AsciiValue fmtStrJS(NEXT_ARG);
